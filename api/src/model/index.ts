...
import cc_cedict_definition, {
  cc_cedict_definitionInitializer,
} from './cc_cedict_definition';
...
import student_sentence_listen, {
  student_sentence_listenInitializer,
} from './student_sentence_listen';
import student_sentence_read, {
  student_sentence_readInitializer,
} from './student_sentence_read';
import student_word_listen, {
  student_word_listenInitializer,
} from './student_word_listen';
import student_word_read, {
  student_word_readInitializer,
} from './student_word_read';
...
type ModelId = cc_cedictId | corpusId | sentenceId | studentId | wordId;
