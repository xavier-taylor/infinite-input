...
export type DocumentsAllQueryVariables = Exact<{
...
export type QueryKeySpecifier = ('words' | 'documentsDue' | 'documents' | 'concordanceDocs' | QueryKeySpecifier)[];
