...
export type WordPronunciationQueryVariables = Exact<{
  hanzi: Scalars['String'];
}>;


export type WordPronunciationQuery = (
  { __typename?: 'Query' }
  & { wordPronunciation: (
    { __typename?: 'Pronunciation' }
    & Pick<Pronunciation, 'hanzi' | 'url'>
  ) }
);
...
export const WordPronunciationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"WordPronunciation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"hanzi"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"wordPronunciation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"hanzi"},"value":{"kind":"Variable","name":{"kind":"Name","value":"hanzi"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hanzi"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]} as unknown as DocumentNode<WordPronunciationQuery, WordPronunciationQueryVariables>;
