...
export type DocumentWordsQueryVariables = Exact<{
  documentId: Scalars['String'];
...
export type DocumentWordsQuery = (
  { __typename?: 'Query' }
  & { document: (
    { __typename?: 'Document' }
    & { sentences: Array<(
      ...
      & { words: Array<(
        { __typename?: 'SentenceWord' }
        & MakeOptional<Pick<SentenceWord, 'forgotLISTEN' | 'forgotREAD' | 'wordHanzi' | 'universalPartOfSpeech'>, 'forgotLISTEN' | 'forgotREAD'>
      )> }
    )> }
  ) }
);
...
export type DueQuery = (
  ...
  & { due: (
    ...
    & { documents: Array<(
      ...
      { __typename?: 'StudentWordStudy' }
      & Pick<StudentWordStudy, 'hanzi' | 'due' | 'studyType'>
      & { word: (
        { __typename?: 'Word' }
        & Pick<Word, 'hanzi'>
        & { ccceDefinitions: Array<(
...
export const DueDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Due"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"studyType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"StudyType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"dayStartUTC"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"due"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"studyType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"studyType"}}},{"kind":"Argument","name":{"kind":"Name","value":"dayStartUTC"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dayStartUTC"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntireDocument"}}]}},{"kind":"Field","name":{"kind":"Name","value":"orphans"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hanzi"}},{"kind":"Field","name":{"kind":"Name","value":"due"}},{"kind":"Field","name":{"kind":"Name","value":"word"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hanzi"}},{"kind":"Field","name":{"kind":"Name","value":"ccceDefinitions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"simplified"}},{"kind":"Field","name":{"kind":"Name","value":"traditional"}},{"kind":"Field","name":{"kind":"Name","value":"pinyin"}},{"kind":"Field","name":{"kind":"Name","value":"definitions"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"studyType"}}]}}]}}]}},...EntireDocumentFragmentDoc.definitions]} as unknown as DocumentNode<DueQuery, DueQueryVariables>;
